...
def plot_trajectories(times, leader, cf2, cf3, cf4, goals, obstacles):
    ...
    # plt.plot(filtered_cf4[0], filtered_cf4[1], c='blue', linestyle='--', linewidth=2)
...
# Example usage
filename = 'vicon_data/exp1_2_drone_static/drone_poses_exp1.txt'  # Change this to the actual filename
times, leader, cf2, cf3, cf4 = extract_positions(filename)

# Define the goals and obstacles (you can have more than one of each)
goals = [[1.7532404661178589, -1.3301429748535156]]  # Example: 1 goal
obstacles = [
    [-0.93521798,  1.52293587],  
    [-1.3444171,   0.493029],
    [0.96231401, -1.81972384],
     [ 0.89605099, -0.31324449],
       [-0.48011395, -0.61373031], 
         [ 0.321652, 0.46232441 ]
]
